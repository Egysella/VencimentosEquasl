...
public class TrabalhadorPeca extends Trabalhador {
    ...
    /**
     * O bónus aplicado ao vencimento devido à alta produtividade
     * */
    private static float bonusRendimento = 0.05f;

    /**
     * Objetivo de produção de peças para obtenção de bónus
     * */
    private static int numPecasBonus = 1000;
    ...
    public boolean equals(Object outroObjeto) {
        ...
        return this.numeroPecasTipo1 == tp.numeroPecasTipo1 && this.numeroPecasTipo2 == tp.numeroPecasTipo2;
    }
    ...
    public float calcularVencimento() {
        return totalPecas() < numPecasBonus ? (numeroPecasTipo1 * pagamentoPecaTipo1)
                + (numeroPecasTipo2 * pagamentoPecaTipo2) : numeroPecasTipo1 * pagamentoPecaTipo1
                + numeroPecasTipo2 * pagamentoPecaTipo2 + (bonusRendimento * (numeroPecasTipo1 * pagamentoPecaTipo1
                + numeroPecasTipo2 * pagamentoPecaTipo2));
    }

    /**
     * Método que devolve o total de peças produzidas pelo trabalhador
     * */
    public int totalPecas(){
        return numeroPecasTipo1 + numeroPecasTipo2;
    }
    ...
    /**
     * Devolve o valor do bónus a aplicar ao salário devido à alta produtividade
     * */
    public static float getBonusRendimento(){
        return bonusRendimento;
    }

    /**
     * Devolve o número de peças necessário para obtenção do bónus
     * */
    public static int getNumPecasBonus(){
        return numPecasBonus;
    }
    ...
    /**
     * Modifica o valor do bónus a aplicar
     *
     * @param bonusRendimento o novo valor do bónus
     * */
    public static void setBonusRendimento(float bonusRendimento){
        TrabalhadorPeca.bonusRendimento = bonusRendimento;
    }

    /**
     * Modifica o valor do número de peças necessárias para obtenção de bónus
     *
     * @param numPecasBonus o novo número de peças necessárias
     * */
    public static void setNumPecasBonus(int numPecasBonus){
        TrabalhadorPeca.numPecasBonus = numPecasBonus;
    }
}